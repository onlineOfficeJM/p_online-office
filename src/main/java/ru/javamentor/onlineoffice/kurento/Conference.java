...
public class Conference implements Closeable {
	private final Logger log = LoggerFactory.getLogger(Conference.class);
	...
	public Conference(String roomName, MediaPipeline pipeline) {
		this.name = roomName;
	...
	public void close() {
		...
		pipeline.release(new Continuation<Void>() {
			...
			public void onSuccess(Void result) throws Exception {
				log.trace("ROOM {}: Released Pipeline", Conference.this.name);
			}

			@Override
			public void onError(Throwable cause) throws Exception {
				log.warn("PARTICIPANT {}: Could not release Pipeline", Conference.this.name);
			}
		});
